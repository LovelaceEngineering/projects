...
title: Sotto il Cofano — Internals di Docker

description: |
  Linux namespaces, cgroups v2 e OverlayFS: i tre pilastri che Docker usa per isolare,
  limitare ed eseguire i container. Hands-on con unshare, pivot_root e veth pair.
