...
title: Osservabilità, Troubleshooting e Gestione del Cluster

description: |
  I 3 pilastri (logs/metrics/traces), metodi RED e USE. Troubleshooting sistematico
  a strati. kube-prometheus-stack con Helm. Upgrade del cluster con kubeadm.
