...
challenges:
  u6_rbac_least_privilege_e1d78bb9: {}
  u6_multizone_spread_87594f0a: {}
---
...
# Crea Role "full-access" e RoleBinding

# Team B: sola lettura
kubectl create namespace team-b
kubectl create serviceaccount team-b-sa -n team-b
# Crea Role "read-only" e RoleBinding
...
```bash
# Verifica che il Pod parta ancora correttamente
