...
# Skill path "build-container-images" referenziato nel body come testo
# (skill_paths non è un attributo frontmatter supportato)

challenges:
  u2_dockerfile_diet_f1ddd7e6: {}
  u2_private_registry_c8dcfe79: {}
---
